...
{ int s__info_callback = 0;
  int s__in_handshake = 0;
  int s__state ;
  int s__new_session ;
  int s__server ;
  int s__version = 0;
  ...
  int s__debug = 0;
  int s__shutdown ;
  int s__ctx__info_callback = 0;
  int s__ctx__stats__sess_connect_renegotiate = 0;
  int s__ctx__stats__sess_connect = 0;
  int s__ctx__stats__sess_hit = 0;
  int s__ctx__stats__sess_connect_good = 0;
  int s__s3__change_cipher_spec ;
  int s__s3__flags ;
  int s__s3__delay_buf_pop_ret ;
  int s__s3__tmp__cert_req = 0;
  int s__s3__tmp__new_compression = 0;
  int s__s3__tmp__reuse_message = 0;
  int s__s3__tmp__new_cipher = 0;
  int s__s3__tmp__new_cipher__algorithms = 0;
  int s__s3__tmp__next_state___0 ;
  int s__s3__tmp__new_compression__id = 0;
