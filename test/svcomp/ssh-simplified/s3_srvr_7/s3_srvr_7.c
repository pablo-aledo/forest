...
{ int s__info_callback = 0;
  ...
  int s__cert__pkeys__AT0__privatekey = 0;
  int s__ctx__info_callback = 0;
  int s__ctx__stats__sess_accept_renegotiate = 0;
  int s__ctx__stats__sess_accept = 0;
  int s__ctx__stats__sess_accept_good = 0;
  ...
  int s__s3__tmp__new_cipher__algo_strength = 0;
